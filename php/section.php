      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>adkklasdmkl adnjksad da <br> wadassdas </h2>
            <p>Lorem ipsum dolor sit amet consectetur, <br>adipisicing elit. 
              Deserunt possimus, <br> iure quae, natus qui quibusdam 
              nulla ea praesentium harum <br> corporis dicta ipsa
              inventore ipsum adipisci reprehenderit, accusamus nisi a magni.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-12 col-md-12 col-lg-4">
              <div class="card text-white text-center bg-dark pb-2">
                  <div class="card-body">
                      ...
                      <h3 class="card-title">Beste Qualität</h3>
